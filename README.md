...
Для обеспечения безопасно авторизации на сервер Pilot-Web необходимо задать следующие настройки:
...
При изменении пути файлов лога не забудте установить права для `pilotwebuser` на запись для папку с логами.
